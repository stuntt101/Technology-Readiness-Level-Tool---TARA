...
<body ng-controller="MainCtrl">
	...
	<modal title="&nbsp; Add Tool" visible="showCreateModal">
	    ...
	    <div class="form-group has-feedback" ng-class="{'has-error': myform.price.$invalid, 'has-success': myform.price.$valid}">
			...
			<div class="dialogButtons">
	     	<button id="create" type="submit" class="btn btn-info" ng-click="createBook()" ng-disabled="myform.$invalid" ><i class="fa fa-book"></i> Create</button>
	     	<button id="cancel" type="button" class="btn btn-info" ng-click="cancel()"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Close</button>
	    </div>
		</form>
	</modal>
	...
	<modal title="&nbsp; Update Book" visible="showUpdateModal">
	    ...
	    <div class="form-group has-feedback" ng-class="{'has-error': myform.price.$invalid, 'has-success': myform.price.$valid}">
			...
			<div class="dialogButtons">
	     	<button id="update" type="submit" class="btn btn-info" ng-click="updateBook(modal.book.isbn13)" ng-disabled="myform.$invalid" ><i class="fa fa-book"></i> Update</button>
	     	<button id="cancel" type="button" class="btn btn-info" ng-click="cancel()"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Close</button>
	    </div>
		</form>
	</modal>
	...
	<div class="panel_north">
		<table style="width: 100%">
			<tr height="30px">
				<td style="width: 50%">
					<div>
						<img src="../../images/new_logo.png" alt="Equipment Readiness & Availability" />
					</div>
					<div class="main_text">Equipment Readiness & Availability </div>
				</td>
				<td></td>
			</tr>
			<tr>
					...
					<table class="toptable">
						<tr>
							<td class="toptable">
								...
								<button name="allbooks" type="submit" class="btn btn-info btn-sm " ng-click="getAllBooks()"><i class="fa fa-book"></i> All Available Tools</button>
								<button name="createbook" type="submit" class="btn btn-info btn-sm " ng-click="showCreateBook()"><i class="fa fa-plus"></i> Create Tool</button>
							</td>
						</tr>
					</table>
				</td>
	...
	<div class="panel_center">
			...
			<div class="div_default">
				<form name="selection_form" novalidate>
					<div class="form-inline">
						...
						<button type="submit" class="btn btn-info btn-sm " ng-click="processSelectedCriteria()"><i class="fa fa-search"></i> Proceed</button> 
						<button type="submit" class="btn btn-info btn-sm " ng-click="resetForm()"><i class="fa fa-close"></i> Reset</button>
					</div> 
				</form>			
			</div>
		...
		<div class="header">3. Select Available Tools</div>
		<div class="content">
	...
	<div ng-element-ready="setDefaults('<%=isDebug %>', '<%=baseUrl %>')"></div>
        <div ng-element-ready="getAllCategories()">
                                    <div class="shell" style="text-align: center ;background-color: blue"> <span class="center">Copyright &copy; CSIR 2017. All Rights Reserved.</span> <span class="right"></span> </div>
